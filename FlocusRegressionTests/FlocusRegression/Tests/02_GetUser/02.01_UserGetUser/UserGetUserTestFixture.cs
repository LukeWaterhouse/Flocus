...
public sealed class UserGetUserTestFixture : IDisposable
{
    ...
    private async Task Prepare()
    {
        ...
        await TestHelpers.CreateUser(DifferentUsername, DifferentPassword, "differentEmail@hotmail.com", DifferentIsAdmin);
    ...
    private async Task Cleanup()
    {
        ...
        await TestHelpers.EnsureNoExsitingAccount(DifferentUsername, DifferentIsAdmin);
    }
}
